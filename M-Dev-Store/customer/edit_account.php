...
$customer_image = $row_customer['customer_images'];
...
if (isset($_POST['update'])) {
	...
	$update_customer = "update customers set customer_name='$c_name',customer_email='$c_email',customer_country='$c_country',customer_city='$c_city',customer_address='$c_address',customer_contact='$c_contact',customer_images='$c_image' where customer_id='$update_id'";

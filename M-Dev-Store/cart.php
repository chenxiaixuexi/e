            ...
            <div class="box">
                ...
                <form action="cart.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="table-responsive">
                        <!-- table-responsive Begin 表格形式，标题衣服最后有总价！！之后需要用php传进来-->
                        ...
                        <table class="table">
                            ...
                            <!-- <tbody>
                                <tr>
                                    <td><img class="img-responsive" src="admin_area/product_images/Product-3a.jpg" alt="Product-3a"></td>
                                    <td><a href="#">MT Closthes Title</a></td>
                                    <td>clothes </td>
                                    <td>clothes Price</td>
                                    <td>Size</td>
            ...
            function update_cart()
            {
                ...
                if (isset($_POST['update'])) {
                    foreach ($_POST['remove'] as $remove_id) {
                        $delete_product = "delete from cart where pro_id='$remove_id'";
                ...
                <!-- <div class='col-md-3 col-sm-6 center-responsive'>
                    ...
                    <div class='product same-height'>
                        ...
                        <div class='text'>
                            ...
                            <h3> <a href='details.php'> mtw </a> </h3>

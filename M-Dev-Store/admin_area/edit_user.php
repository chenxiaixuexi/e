...
<?php 
  ...
  if (isset($_GET['edit_user'])) {
    ...
    $user_image = $row_user['admin_images'];
...
if(isset($_POST['update'])){
    ...
    $update_user = "update admins set admin_name='$user_name', admin_email='$user_email', admin_pass='$user_pass', admin_image='$admin_image', admin_country='$user_country', admin_about='$user_about', admin_contact='$user_job', admin_job='$user_job' where admin_id='$edit_user'";
